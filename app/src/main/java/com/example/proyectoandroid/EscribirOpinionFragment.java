...
import com.example.proyectoandroid.databinding.FragmentEscribirOpinionBinding;
import com.example.proyectoandroid.databinding.FragmentPagoCorrectoBinding;


public class EscribirOpinionFragment extends BaseFragment {
    FragmentEscribirOpinionBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentEscribirOpinionBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.botonConfirmar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String opinion = binding.editTextNombre.getText().toString();
                ...
                if (!error) {
                    showToastDireccion("Opinión añadida correctamente");
